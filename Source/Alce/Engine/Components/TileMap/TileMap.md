...
It is designed exclusively to work with JSON tilemaps generated by <a href="https://pyxeledit.com/" target="_blank">PyxelEdit</a>, which define the grid size, tile dimensions, and layers of tiles.
...
The ```TileMap``` component is responsible for taking a <a href="https://pyxeledit.com/" target="_blank">PyxelEdit</a>-exported tilemap and turning it into something the engine can efficiently render.
...
The system also handles common <a href="https://pyxeledit.com/" target="_blank">PyxelEdit</a> features such as horizontal flips and 90° rotations. To prevent visual artifacts, a small anti-bleeding offset is applied to texture coordinates.
...
> ### ⚠️ Important notes:
> Only JSON maps exported from <a href="https://pyxeledit.com/" target="_blank">PyxelEdit</a> are supported.
